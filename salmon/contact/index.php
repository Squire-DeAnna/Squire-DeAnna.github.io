 ...
 */
 ...
 $errors['security'] = 'Sorry, your entered security code does not match the security
… image.';
 }
 ...
 // Send the message
 $to = 'deanna.squire11@gmail.com';
 $from = "From: $email";
 $result = mail($to, $subject, $finalmessage, $from);

 // Let the sender know what happened
 if ($result == TRUE) {
 $errors[] = "Thank you $name for contacting Salmon River Adventures.";
 } else {
